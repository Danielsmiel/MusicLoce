...
public class PullToRefreshView extends LinearLayout {
	...
	public static Bitmap getBitmapFromSrc(String src) {
		Bitmap bit = null;
		try {
			bit = BitmapFactory.decodeStream(PullToRefreshView.class.getResourceAsStream(src));
		} catch (Exception e) {
...
class ListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		LinearLayout.LayoutParams layoutParamsWW = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
		...
		LinearLayout.LayoutParams layoutParamsWW2 = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
				LayoutParams.WRAP_CONTENT);
		...
		LinearLayout.LayoutParams layoutParamsWW3 = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
				LayoutParams.WRAP_CONTENT);
		layoutParamsWW3.gravity = Gravity.CENTER;
		layoutParamsWW3.rightMargin = PullToRefreshView.scaleValue(mContext, 10);
	...
	public void setState(int state) {
		...
		case STATE_NORMAL:
			...
			if (lastRefreshTime == null) {
				lastRefreshTime = PullToRefreshView.getCurrentDate(PullToRefreshView.dateFormatHMS);
...
class ListViewFooter extends LinearLayout {
	...
	private void initView(Context context) {
		...
		footerView.setMinimumHeight(PullToRefreshView.scaleValue(mContext, 100));
		...
		LinearLayout.LayoutParams layoutParamsWW1 = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
				LayoutParams.WRAP_CONTENT);
